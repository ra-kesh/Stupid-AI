...
export const dashboardConfig: DashboardConfig = {
  main: [{ name: "Dashboard", href: "/dashboard", icon: <LayoutGrid className="size-5 xl:size-7 3xl:size-8" /> }],
  ai: [
    ...
    },
    {
      ...
      icon: <CircleCheck className="size-5 xl:size-7 3xl:size-8" />,
    },
  ],
  account: [
    { name: "Billing", href: "/billing", icon: <Wallet className="size-5 xl:size-7 3xl:size-8" /> },
    { name: "Referrals", href: "/referals", icon: <UserPlus2 className="size-5 xl:size-7 3xl:size-8" /> },
    { name: "Teams", href: "/teams", icon: <Users className="size-5 xl:size-7 3xl:size-8" /> },
  ],
}
