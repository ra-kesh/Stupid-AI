...
export function FileUploaderDashboard(props: FileUploaderProps) {
  const {
    value: valueProp,
    onValueChange,
    onUpload,
      ...
      >
        {({ getRootProps, getInputProps, isDragActive }) => (
          <div
            {...getRootProps()}
            className={cn(
              "group relative grid w-64 cursor-pointer place-items-center rounded-lg border border-separator px-5 py-2.5 text-center transition hover:bg-inherit xl:py-2.5 2xl:py-3 4xl:py-5",
            ...
            {isDragActive ? (
              ...
              <div className="flex flex-col items-center justify-center sm:px-5 xl:gap-1">
                <div className="rounded-full bg-slider p-2 2xl:p-3 ">
                  <Upload className="text-foreground lg:size-4 xl:size-5 2xl:size-6 4xl:size-8" aria-hidden="true" />
                </div>
                <div className="space-y-px">
                  <p className="line-clamp-2 text-xs font-medium text-muted-foreground 4xl:text-sm ">
                    Click to browse files or drop to upload your profile picture
                  </p>
