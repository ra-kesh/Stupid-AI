  ...
  return (
    <Card className="col-span-8 border-0  bg-inherit">
      <CardHeader className="flex flex-row items-center justify-between px-0 ">
        <CardTitle className="text-logo text-2xl font-bold leading-7 tracking-wide">History</CardTitle>
      </CardHeader>
        ...
        <Table>
          ...
          <TableBody className="rounded-3xl ">
            <TableRow>
              ...
              <TableCell className="text-textforeground py-8">Feb 12, 2024 12:44 PM</TableCell>
              <TableCell className="text-textforeground py-8">View All </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="py-8 text-center">1</TableCell>
              <TableCell className=" py-8">
