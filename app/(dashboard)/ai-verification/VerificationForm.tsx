...
const VerificationForm = () => {
  return (
    <Card className="col-span-12 bg-inherit">
      ...
      <CardContent className="grid grid-cols-1 gap-x-4 bg-form lg:grid-cols-12 lg:rounded-md lg:p-6 xl:gap-x-8 xl:rounded-lg xl:p-8 2xl:gap-x-10 2xl:rounded-xl 2xl:p-10">
        <PromptForm />
        <FaceSwapForm />
      </CardContent>
    </Card>
